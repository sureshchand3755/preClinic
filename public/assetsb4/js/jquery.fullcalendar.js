...
!function($) {
    ...
    CalendarApp.prototype.onEventClick =  function (calEvent, jsEvent, view) {
        var $this = this;
            ...
            form.append("<div class='input-group m-b-20'><input class='form-control' type=text value='" + calEvent.title + "' /><span class='input-group-prepend'><button type='submit' class='btn btn-primary'>Save</button></span></div>");
            $this.$modal.modal({
                backdrop: 'static'
            });
