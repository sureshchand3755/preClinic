...
<div class="page-wrapper">
    <div class="content">
        ...
        @slot('li_1') Roles & Permissions @endslot              
        @endcomponent
        <div class="row">
            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-3">
                <a href="add-role" class="btn btn-primary btn-block w-100"><i class="fa fa-plus"></i> Add Roles</a>
                    ...
                    <ul>
                        <li class="active">
                            ...
                            <span class="role-action">
                                ...
                                <a href="#" data-bs-toggle="modal" data-bs-target="#delete_role">
...
<div id="delete_role" class="modal fade delete-modal" role="dialog">
    ...
    @slot('li_1') Are you sure want to delete this Role? @endslot              
    @endcomponent
</div>
