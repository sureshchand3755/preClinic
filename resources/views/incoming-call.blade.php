    ...
    <div class="sidebar-inner slimscroll">
        <div class="sidebar-menu">
            <ul>
                ...
                <li class="active">
                    <a href="{{url('chat')}}"><span class="chat-avatar-sm user-img"><img src="{{ URL::asset('/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status online"></span></span> Mike Litorus <span class="badge rounded-pill bg-danger float-end">108</span></a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="navbar">
                            <div class="user-details me-auto">
                                <div class="float-start user-img m-r-10">
                                    <a href="{{url('profile')}}" title="Mike Litorus"><img src="{{ URL::asset('/assets/img/user.jpg')}}" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                </div>
                                <div class="user-info float-start">
                                    <a href="{{url('profile')}}" title="Mike Litorus"><span class="font-bold">Mike Litorus</span></a>
                    ...
                    <div class="chat-contents">
                        <div class="chat-content-wrap">
                            <div class="voice-call-avatar">
                                <img src="{{ URL::asset('/assets/img/user-03.jpg')}}" alt="" class="call-avatar">
                            ...
                            <div class="call-users">
                                <ul>
                                    ...
                                    <li>
                                        <a href="">
                                            <img src="{{ URL::asset('/assets/img/user-05.jpg')}}" class="img-fluid" alt="">
                                            <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="">
                                            <img src="{{ URL::asset('/assets/img/user-06.jpg')}}" class="img-fluid" alt="">
                                            <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                        </a>
                                    </li>
                                </ul>
