...
@endif
@if(Route::is(['departments','doctor','employees','expenses','holidays','leave-type','leaves','patients','taxes','provident-fund','roles-permissions','salary']))
<div class="modal-dialog modal-dialog-centered">
	<div class="modal-content">
		<div class="modal-body text-center">
			<img src="{{ URL::asset('/assets/img/sent.png')}}" alt="" width="50" height="46">
            ...
            <div class="modal-body">
                <div class="profile-widget">
                    <div class="profile-img">
                        <a href="{{url('profile')}}" class="avatar"><img src="{{ URL::asset('/assets/img/user-03.jpg')}}" alt=""></a>
                    </div>
                    <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('profile')}}">Tressa Wexler</a></h4>
                    <div class="small text-muted">calling ...</div>
                    <div class="incoming-btns">
                        <a href="{{url('chat')}}" class="btn btn-success m-r-10">Decline</a>
                        <a href="{{url('profile')}}" class="btn btn-danger">Answer</a>
                    </div>
                </div>
            </div>
        </div>
