    ...
    <div class="sidebar-inner slimscroll">
        <div class="sidebar-menu">
            <ul>
                ...
                <li class="menu-title">Chat Groups <a href="#" class="add-user-icon" data-bs-toggle="modal" data-bs-target="#add_group"><i class="fa fa-plus"></i></a></li>
                <li>
                    <a href="{{url('chat')}}">#General</a>
                </li>
                <li>
                    <a href="{{url('chat')}}">#Video Responsive Survey</a>
                </li>
                <li>
                    <a href="{{url('chat')}}">#500rs</a>
                </li>
                <li>
                    <a href="{{url('chat')}}">#warehouse</a>
                </li>
                <li class="menu-title">Direct Chats <a href="#" class="add-user-icon" data-bs-toggle="modal" data-bs-target="#add_chat_user"><i class="fa fa-plus"></i></a></li>
                <li>
                    <a href="{{url('chat')}}"><span class="chat-avatar-sm user-img"><img src="{{ URL::asset('/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status online"></span></span> John Doe <span class="badge rounded-pill bg-danger float-end">1</span></a>
                </li>
                <li>
                    <a href="{{url('chat')}}"><span class="chat-avatar-sm user-img"><img src="{{ URL::asset('/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status offline"></span></span> Richard Miles <span class="badge rounded-pill bg-danger float-end">18</span></a>
                </li>
                <li>
                    <a href="{{url('chat')}}"><span class="chat-avatar-sm user-img"><img src="{{ URL::asset('/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status away"></span></span> John Smith</a>
                </li>
                <li class="active">
                    <a href="{{url('chat')}}"><span class="chat-avatar-sm user-img"><img src="{{ URL::asset('/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status online"></span></span> Jennifer <span class="badge rounded-pill bg-danger float-end">108</span></a>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="fixed-header">
                        <div class="navbar">
                            <div class="user-details me-auto">
                                <div class="float-start user-img m-r-10">
                                    <a href="{{url('profile')}}" title="Jennifer Robinson"><img src="{{ URL::asset('/assets/img/patient-thumb-02.jpg')}}" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                </div>
                            ...
                            <ul class="nav custom-menu">
                                <li class="nav-item">
                                    <a href="#chat_sidebar" class="nav-link task-chat profile-rightbar float-end" id="task_chat"><i class="fa fa-user"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('voice-call')}}"><i class="fa fa-phone"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('video-call')}}"><i class="fa fa-video-camera"></i></a>
                                </li>
                                        ...
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a href="{{url('profile')}}" class="avatar">
                                                    <img alt="Jennifer Robinson" src="{{ URL::asset('/assets/img/patient-thumb-02.jpg')}}" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                                <div class="chat-bubble">
                                ...
                                <div class="chat-box">
                                    <div class="chats">
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a href="{{url('profile')}}" class="avatar">
                                                    <img alt="Cristina Groves" src="{{ URL::asset('/assets/img/doctor-thumb-03.jpg')}}" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                                <div class="chat-bubble">
                                        ...
                                        <div class="table-content">
                                            <div class="chat-profile-img">
                                                <div class="edit-profile-img">
                                                    <img src="{{ URL::asset('/assets/img/doctor-03.jpg')}}" alt="">
                                                    <span class="change-img">Change Image</span>
                                                </div>
                                                <h3 class="user-name m-t-10 mb-0">Cristina Groves</h3>
                                                <small class="text-muted">Gynecologist</small>
                                                <a href="{{url('edit-profile')}}" class="btn btn-primary edit-btn"><i class="fa fa-pencil"></i></a>
                                            </div>
                                            <div class="chat-profile-info">
                                                <ul class="user-det-list">
                                                    <li>
                                                        <span>Username:</span>
                                                        <span class="float-end text-muted">@cristina_groves</span>
                                                    </li>
                                                    <li>
                                                        <span>DOB:</span>
                                                        <span class="float-end text-muted">3rd March</span>
                                                    </li>
                                                    <li>
                                                        <span>Email:</span>
                                                        <span class="float-end text-muted">cristinagroves@example.com</span>
                                                    </li>
                                                    <li>
                                                        <span>Phone:</span>
                                                        <span class="float-end text-muted"> 770-889-6484</span>
                                                    </li>
                                                </ul>
                                            </div>
                                                                ...
                                                                <div class="files-cont">
                                                                    ...
                                                                    <ul class="files-action">
                                                                        <li class="dropdown dropdown-action">
                                                                            <a href="" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                                ...
                                <a href="#">
                                    <div class="media d-flex">
										<span class="avatar align-self-center">
											<img src="{{ URL::asset('/assets/img/user.jpg')}}" alt="John Doe">
										</span>
