										...
										<tbody>
											<tr class="table-form-control add-row">
												...
												<td class="add-remove text-end">
													...
													<a href="#" class="copy-btn me-2"><i class="fas fa-copy"></i></a><a href="javascript:void(0);" class="remove-btn"><i class="feather-trash-2"></i></a>
												</td>
											</tr>
											<tr class="table-form-control add-row">
												<td>
									...
									<div class="invoice-fields">
										...
										<div class="field-box">
											...
											<div class="payment-details">
												...
												<a href="#" data-bs-toggle="modal" data-bs-target="#delete_bank_details"><i class="feather-trash-2"></i></a>
											</div>
										</div>
									</div>
