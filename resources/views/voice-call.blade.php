                        ...
                        <div class="navbar">
                            <div class="user-details me-auto">
                                <div class="float-start user-img m-r-10">
                                    <a href="{{url('profile')}}" title="Jennifer Robinson"><img src="{{ URL::asset('/assets/img/user.jpg')}}" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                </div>
                                <div class="user-info float-start">
                                    <a href="{{url('profile')}}" title="Jennifer Robinson"><span class="font-bold">Jennifer Robinson</span></a>
                                    <span class="last-seen">Online</span>
                                </div>
                            </div>
                            <ul class="nav float-end custom-menu">
                                <li class="nav-item">
                                    <a class="task-chat profile-rightbar float-end" href="#chat_sidebar" id="task_chat"><i aria-hidden="true" class="fa fa-comments"></i></a>
                                </li>
                    ...
                    <div class="chat-contents">
                        <div class="chat-content-wrap">
                            <div class="voice-call-avatar">
                                <img src="{{ URL::asset('/assets/img/doctor-03.jpg')}}" alt="" class="call-avatar">
                            ...
                            <div class="call-users">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('/assets/img/user-04.jpg')}}" class="img-fluid" alt="">
                                            <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('/assets/img/patient-thumb-02.jpg')}}" class="img-fluid" alt="">
                                            <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ URL::asset('/assets/img/patient-thumb-01.jpg')}}" class="img-fluid" alt="">
                                            <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                        </a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a href="{{url('profile')}}" class="avatar">
                                                    <img alt="John Doe" src="{{ URL::asset('/assets/img/user.jpg')}}" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                                                ...
                                                                <div class="chat-content">
                                                                    ...
                                                                    <ul class="attach-list">
                                                                        <li class="img-file">
                                                                            ...
                                                                            <div class="attach-img"><img src="{{ URL::asset('/assets/img/user.jpg')}}" alt=""></div>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
