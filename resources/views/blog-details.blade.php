...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
                ...
                <div class="blog-view">
                    <article class="blog blog-single-post">
                        ...
                        <div class="blog-image">
                            <a href="#."><img alt="" src="{{ URL::asset('/assets/img/blog/blog-01.jpg')}}" class="img-fluid"></a>
                        </div>
                        ...
                        <div class="about-author">
                            <div class="about-author-img">
                                <div class="author-img-wrap">
                                    <img class="img-fluid rounded-circle" alt="" src="{{ URL::asset('/assets/img/user.jpg')}}">
                                </div>
                            </div>
                            ...
                            <li>
                                <div class="comment">
                                    <div class="comment-author">
                                        <img class="avatar" alt="" src="{{ URL::asset('/assets/img/user.jpg')}}">
                                    </div>
            ...
            <aside class="col-md-4 theiaStickySidebar">
                ...
                <div class="widget post-widget">
                    ...
                    <ul class="latest-posts">
                        <li>
                            ...
                            <div class="post-info">
                                <h4>
									<a href="{{url('blog-details')}}">Lorem ipsum dolor sit amet consectetur</a>
								</h4>
